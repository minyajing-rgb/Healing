...
try:
 with sync_playwright() as p:
  ...
  check('MapLibre engine initialized',page.evaluate("window.EARTH_HEALING_MAP.engine.startsWith('maplibre')"))
  ...
  check('Mobile enhanced engine works',mobile.evaluate("window.EARTH_HEALING_MAP.engine.startsWith('maplibre')"))
