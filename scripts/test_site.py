...
try:
 with sync_playwright() as p:
  ...
  check('Approved high-resolution hero decodes',page.evaluate("async()=>{let i=new Image();i.src='./assets/media/hero-garden.avif';await i.decode();return i.naturalWidth>=1000}"))
  check('Approved illustrated atlas decodes',page.evaluate("async()=>{let i=new Image();i.src='./assets/media/map-atlas.avif';await i.decode();return i.naturalWidth>=1000}"))
  check('Approved botanical atlas decodes',page.evaluate("async()=>{let i=new Image();i.src='./assets/media/atlas-lavender.avif';await i.decode();return i.naturalWidth>=1000}"))
