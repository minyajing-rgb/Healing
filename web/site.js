...
(() => {
  ...
  const storyArt={
    grasse:'./assets/media/hero-garden.webp',
    padua:'./assets/media/atlas-lavender.webp',
    chelsea:'./assets/media/atlas-lavender.webp',
    forest:'./assets/media/hero-garden.webp',
    rongoa:'./assets/media/hero-garden.webp',
    ebers:'./assets/media/map-atlas.webp',
    kallawaya:'./assets/media/map-atlas.webp',
    argan:'./assets/media/map-atlas.webp',
    jamu:'./assets/media/atlas-lavender.webp'
  };
